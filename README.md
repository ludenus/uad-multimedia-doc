...
**Бранч** (branch) - гілка, один із можливих варіантів документа, який для зручності також має унікальне ім'я і відрізняється від основного варіанту (master) іншою послідовністю коммітів. Типово кожний користувач використовує свій окремий бранч для внесення змін. Коли всі необхідні зміни додані - бранчі можна порівнювати і об'єднювати. Переключатись між бранчами можна можна [тут](https://github.com/ludenus/uad-multimedia-doc/commits/master)
