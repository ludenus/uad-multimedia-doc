...
**Репозиторій** (repository) - вся сукупність даних проекту, всіх його версій, тегів, бранчів, а також вся історія їх змін - тобто все, що було проіндекссоваано системою контролю версій. Репозиторій, в якому зберігається цей документ, доступний за таким гіпорпосиланням: https://github.com/ludenus/uad-multimedia-doc
