...
**Бранч** (branch) - гілка, один із можливих варіантів документа, який для зручності також має унікальне ім'я і відрізняється від основного варіанту (master) іншою послідовністю коммітів. Типово кожний користувач використовує свій окремий бранч для внесення змін. Коли всі необхідні зміни додані - бранчі можна порівнювати і об'єднювати. Переключатись на певний бранч або тег можна можна [тут](https://github.com/ludenus/uad-multimedia-doc/commits/master)
...
**Пулл-реквест** (pull-request) - запит на внесення змін. Як правило застосовується, коли над проектом працює декілька людей. Типово заохочує інших учасників проекту робити перегляд змін і надавати зворотній зв'язок автору. Пулл-реквест може бути прийнято (бранч користувача буде помержений з мастером), відхилено (пропоновані зміни однозначно небажані з точки зору інших співавторів), або відмічено для подальшого обговорення і вдосконалення запропонованих змін. Створити новий пулл-реквест можна [тут](https://github.com/ludenus/uad-multimedia-doc/pulls)
...
**Репозиторій** (repository) - вся сукупність даних проекту, всіх його версій, тегів, бранчів, а також вся історія їх змін - тобто все, що було проіндекссоваано системою контролю версій. Репозиторій, в якому зберігається цей документ, доступний за таким гіперпосиланням: https://github.com/ludenus/uad-multimedia-doc

## Корисні функції
На прикладі цього документа ми бачимо, які корисні можливості Git/GitHub дає користувачам:
* Створення і публікацию мультимедійних документів, які містять: текст із форматуванням, зображення, гіперпосилання на інші документи.
...
### IDE
Робота в IDE може виконуватись оффлайн - тобто без доступу до Інтернету. При цьому під час редагування одночасно доступниий і режим перегляду. Зміни зберігаються на локальну файлову систему, а коли зв'язок стає доступний - можуть бути синхронізовані звичайними засобами роботи з Git.
