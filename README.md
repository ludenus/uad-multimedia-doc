...
## Корисні функції
Git/GitHub дає користувачам такі корисні можливості:
...
* Редагування тексту онлайн безпосередньо в браузері.
* Спільної роботи над документами багатьом співавторам.
